...
const WorkDetails = () => {
    ...
    return (
        <div className="p-8 bg-white w-80 rounded-xl shadow-md">
            ...
            <div className="">
                {steps.map(step => (
                    <div
                        key={step.id}
                        className="  bg-white px-6 py-2 rounded-lg  border border-gray-400 hover:shadow-xl transition duration-300 w-65 pl-5 h-30 mb-4"
                    >
                        <div className='flex'>
                            <div>{step.icon}</div>
