...
const Banner = () => {
    return (
        <div className='w-11/12 mx-auto max-w-full bg-base-300 py-8'>
            <div className="hero bg-white rounded-2xl shadow-md overflow-hidden">
                <div className="hero-content flex flex-col lg:flex-row-reverse items-center lg:items-start px-5 py-8 lg:py-16 gap-6">
                    ...
                    <div className='w-full lg:w-1/2 text-center lg:text-left'>
                        ...
                        <button className="btn bg-slate-600 text-white font-bold hover:bg-amber-500 px-6 py-3 text-sm sm:text-base">
                            Get Started
                        </button>
                    </div>
